...
- (void)newCodeChooose
{
    ...
    [LBXAlertAction showAlertWithTitle:@"请选择" msg:@"kkkkk" chooseBlock:^(NSInteger buttonIdx) {
    ...
    } buttonsStatement:@"二维码+logo",@"二维码上色",@"二维码前景颜色+背景颜色",@"商品条形码",@"code93(支付宝付款条形码)",nil];
...
- (void)createQR1
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:@"黄焱" size:_qrImgView.bounds.size];
    
    CGSize logoSize=CGSizeMake(30, 30);
    UIImageView* imageView = [self roundCornerWithImage:[UIImage imageNamed:@"twitteer3.png"] size:logoSize];
