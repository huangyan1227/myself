...
- (instancetype)init
{
    ...
    if (self) {
        ...
        //上下必须一致
        self.frame = CGRectMake(0, 0, kViewWidth, kViewHeight-160);
...
- (void)show
{
    ...
    //self.sender.view.backgroundColor =[UIColor orangeColor];
    ...
    if (self.animate) {
        CGPoint fromPoint = CGPointMake(kViewWidth/2, kViewHeight+kBaseViewHeight);
        CGPoint toPoint   = CGPointMake(kViewWidth/2, kViewHeight-kBaseViewHeight);
